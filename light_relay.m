%% Arduino Group Project: Write Serial to an Arduino
% This code will connect to an Arduino over a Serial Port
% It will ask the user for an H or an L or a q
% H is sent to Arduino over serial
% L is sent to Arduino over serial
% q quits the program
...
usr_input = 'm';% initialize the usr_input variable
time_matrix = [];
tracker = [];
timeON = 0;
timeOFF = 0;
...
%form year,month,day,hour,min,sec using a 24 hour clock
